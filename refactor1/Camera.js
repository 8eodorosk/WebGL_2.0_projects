class Camera{
	constructor(gl, fov, near, far){
		...
		let ratio = gl.canvas.width / gl.canvas.height; //aspect ratio
		Matrix4.perspective(this.projectionMatrix, fov || 45, ration, near || 0.1, far || 100.0);
	...
	updateViewMatrix(){
		...
		Matrix4.invert(this.viewMatrix, this.matview.raw);
